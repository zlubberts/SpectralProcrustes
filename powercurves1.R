#Experiment 1: Diffuse noise, measure of strength of HA is given by sigma
...
perturb <- function(X,n,r){
  return(X+matrix(rnorm(n*r),nrow=n)/(2*sqrt(n)))
}
...
save(powercurves,file="powercurves1.RData")
